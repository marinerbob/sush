  ...
  <footer className="px-6 lg:px-8 bg-gray-100 text-gray-400">
    ...
    <div className="py-5 px-24 flex flex-col justify-center items-center">
      ...
      <div className="w-full sm:w-64 flex justify-between items-center">
        <img className="h-10 w-10" src="/icons/sush-logo.svg" alt="VK socials button" />
        <img className="h-10 w-10" src="/icons/sush-logo.svg" alt="Telegram socials button" />
        <img className="h-10 w-10" src="/icons/sush-logo.svg" alt="WhatsUp socials button" />
      </div>
      <div>
